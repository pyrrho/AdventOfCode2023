...
pub fn main() !void {
    ...
    const row_has_galaxy_tracker: []u32 = try allocator.alloc(u32, sky_size);
    const col_has_galaxy_tracker: []u32 = try allocator.alloc(u32, sky_size);
    ...
    { // TODO: There has ot be a better way to init elements to 0...
        ...
        while (i < sky_size) : (i += 1) {
            row_has_galaxy_tracker[i] = 1;
            col_has_galaxy_tracker[i] = 1;
        }
    }
